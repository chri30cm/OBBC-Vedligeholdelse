...
namespace UI
{
    public class Menu
    {
                ...
                try
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case "5":
                            ...
                            break;
                        case "6":
                            ReadAndSaveFromDatabase(); // TEST ! TEST ! TEST !
                            break;
                        case "7":
                            ShowErrorReportsList(); // TEST ! TEST ! TEST !
                            break;
                        default:
        ...
        private void ShowErrorReportsList()
        {
            control.ShowErrorReportsList();
        }

        private void ReadAndSaveFromDatabase()
        {
            control.ReadAndShowFromDatabase();
        }
